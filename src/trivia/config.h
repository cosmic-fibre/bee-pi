...
#define BUILD_INFO "Linux-armv7l-Debug"
#define BUILD_OPTIONS "cmake . -DCMAKE_INSTALL_PREFIX=/usr/local -DENABLE_TRACE=ON -DENABLE_BACKTRACE=Off"
#define COMPILER_INFO "/usr/bin/cc /usr/bin/c++"
#define BEE_C_FLAGS " -fno-omit-frame-pointer -fno-stack-protector -fexceptions -funwind-tables -fopenmp -std=c11 -Wall -Wextra -Wno-sign-compare -Wno-strict-aliasing -fno-gnu89-inline -Werror"
#define BEE_CXX_FLAGS " -fno-omit-frame-pointer -fno-stack-protector -fexceptions -funwind-tables -fopenmp -std=c++11 -Wall -Wextra -Wno-sign-compare -Wno-strict-aliasing -Wno-invalid-offsetof -Werror"

/*
 * Modules
 */
#define MODULE_LIBDIR "/usr/local/lib/bee"
...
#define MODULE_LIBPATH "/usr/local/lib/bee/?.so"
